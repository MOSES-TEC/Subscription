...
"""
# Import Django environ and to initialize environment variables
import environ
env = environ.Env()
...
DATABASES = {
    ...
    'default': dj_database_url.parse(env('RAILWAY_DATABASE_URL')),
...
# Email configuration settings: (SMTP Configuration)
...
DEFAULT_FROM_EMAIL = env('DEFAULT_FROM_EMAIL') # Admin Email (where all the email comes from)
